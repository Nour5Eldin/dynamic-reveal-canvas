      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex gap-6">
          <a 
            ...
            className="group p-3 rounded-full border-2 border-gray-600 transition-all duration-300 hover:border-transparent hover:bg-gradient-to-r hover:from-cyan-400 hover:via-blue-500 hover:to-purple-500"
          >
